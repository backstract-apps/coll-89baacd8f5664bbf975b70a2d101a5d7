...
app = FastAPI(title='Backstract Generated APIs - coll-89baacd8f5664bbf975b70a2d101a5d7', debug=False,
              docs_url='/fervent-bose-ce46c2060acb11f092110242ac12000573/docs',
              openapi_url='/fervent-bose-ce46c2060acb11f092110242ac12000573/openapi.json')
...
app.include_router(
    router,
    prefix='/fervent-bose-ce46c2060acb11f092110242ac12000573/api',
    tags=['APIs v1']
)
